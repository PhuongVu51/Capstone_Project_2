...
def test_auth_01():
    ...
    try:
        ...
        if form:
            driver.save_screenshot("screenshots/TC_AUTH_01_Evidence.png")
...
def test_auth_02():
    ...
    try:
        ...
        if "dashboard_production" in driver.current_url:
            driver.save_screenshot("screenshots/TC_AUTH_02_Evidence.png")
...
def test_auth_03():
    ...
    try:
        ...
        if "qc_dashboard" in driver.current_url:
            driver.save_screenshot("screenshots/TC_AUTH_03_Evidence.png")
...
def test_auth_04():
    ...
    try:
        ...
        if "dashboard_warehouse" in driver.current_url:
            driver.save_screenshot("screenshots/TC_AUTH_04_Evidence.png")
...
def test_auth_05():
    ...
    try:
        ...
        if "error=wrong_credentials" in driver.current_url:
            driver.save_screenshot("screenshots/TC_AUTH_05_Evidence.png")
...
def test_auth_06():
    ...
    try:
        ...
        if "error=wrong_credentials" in driver.current_url:
            driver.save_screenshot("screenshots/TC_AUTH_06_Evidence.png")
...
def test_auth_07():
    ...
    try:
        ...
        time.sleep(1)
        if "dashboard_production" in driver.current_url:
            driver.save_screenshot("screenshots/TC_AUTH_07_Evidence.png")
...
def test_auth_08():
    ...
    try:
        ...
        if "dashboard_director" in driver.current_url:
            driver.save_screenshot("screenshots/TC_AUTH_08_Evidence.png")
...
def test_auth_09():
    ...
    try:
        ...
        if "login.php" in driver.current_url:
            driver.save_screenshot("screenshots/TC_AUTH_09_Evidence.png")
            log("TC_AUTH_09", "Protected page without session", "PASS")
        else:
            driver.save_screenshot("screenshots/BUG_TC_AUTH_09.png")
...
def test_auth_10():
    ...
    try:
        ...
        if "login.php" in url or "403" in driver.page_source or "qc_dashboard" in url:
             driver.save_screenshot("screenshots/TC_AUTH_10_Evidence.png")
             log("TC_AUTH_10", "Wrong role receives 403 or redirect", "PASS")
        else:
             driver.save_screenshot("screenshots/BUG_TC_AUTH_10.png")
